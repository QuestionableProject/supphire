...
<head>
    ...
    <link rel="stylesheet" href="css/curt.css">
</head>
<body>
        ...
        <div class="order">
            ...
            <div class="order-block">
                <form action="" class="order-form">
                    <input class="check" type="text" placeholder="ФИО" required>
                    <input class="check1" type="text" placeholder="Адрес" required>
                    <input class="check2" type="number" placeholder="Телефон" data-number required>
                    <input type="email" placeholder="EMAIL (Для чека)">
                    <input class="promo" type="text" maxlength="15" placeholder="Промокод">
                    <button  class="order-btn" type="button"class="order-btn">Оформить!</button>
                </form>
                <div class="product-curt">
                    <div class="pc-text">
                        <h3>Корзина</h3>
            ...
            <h1 class="end">Корзина пуста</h1>
            <div class="ofer">
                <h3>Заказ оформлен!</h3>
                <P>Скоро вам перезвонят для уточнения</P>
            </div>
        </div>
    </main>
